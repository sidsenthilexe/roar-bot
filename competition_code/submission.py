...
class RoarCompetitionSolution:
    ...
    async def step(
        ...
        speed_wp_1 = self.maneuverable_waypoints[(self.current_waypoint_idx + 30) % len(self.maneuverable_waypoints)]

        speed_wp_2 = self.maneuverable_waypoints[(self.current_waypoint_idx + 50) % len(self.maneuverable_waypoints)]
